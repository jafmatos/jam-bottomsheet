...
const props = BottomSheetPropsBuilder.one().withSnapPointsCollapsed(400).withDismissKeyboardOnClose(false).build();

export default {
  url: makeDeepLinkFromBottomSheetProps({ ...props, content: BottomSheetContentOptions.Form }),
};
